...
export default { AdminEmailTemplateUserCreated, PasswordResetTemplate, TrialPeriodChangeTemplate, TrialExtensionTemplate };
            ...
            <tr>
              <td align="center" bgcolor="#04f6f1" style="padding:40px 30px; background:linear-gradient(135deg, rgba(4,246,241,0.9), rgba(21,214,231,0.8)); text-align:center;">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center">
                  <tr>
                    <td align="center" style="border-radius:30px; background:linear-gradient(135deg, #863793, #A04DB5); box-shadow:0 5px 20px rgba(134,55,147,0.4);">
                      <a href="${website_url}/consumer/payment?amount=${total}&invoice_id=${invoice_id}&user_id=${user_id}&invoice_number=${encodeURIComponent(invoice_number)}" style="display:inline-block; padding:15px 50px; color:#ffffff; text-decoration:none; font-weight:700; font-size:15px;">→ Pay Now</a>
                    </td>
                  </tr>
                </table>
              </td>
